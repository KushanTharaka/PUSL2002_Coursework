<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DoA HomePage.aspx.cs" Inherits="WEB_Project.DoA_HomePage" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>DoA Home Page</title>
...
<body>
    ...
    <script>
        ...
        <form id="form1" runat="server">
            ...
            <div class="navbar">
                <a class="active" href="DoA HomePage.aspx" style="font-family: Arial"><i class="fa fa-tree" aria-hidden="true"></i> Department of Agriculture</a>
                <a href="Customer Messages1.aspx" style="font-family: Arial"><i class="fa fa-comments-o" aria-hidden="true"></i> Messages</a>
                <a href="DoA Charts.aspx" style="font-family: Arial"><i class="fa fa-bar-chart" aria-hidden="true"></i> Reports</a>
            ...
            <div style="padding-left: 40%">
                <table>
                    <tr>
                        ...
                        <td><asp:TextBox ID="nic" runat="server"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td style="color: white; font-weight: bold">Status: </td>
                        <td><asp:RadioButtonList runat="server" ID="stat" ForeColor="White">
                    ...
                    <tr>
                        <td></td>
                    <td><asp:Button ID="btnupdate" runat="server" Text="Update" OnClick="btnupdate_Click" BackColor="#009933" BorderColor="White" Font-Bold="True" ForeColor="White" Height="30px" /></td>
                    </tr>
                </table>
            </div>
