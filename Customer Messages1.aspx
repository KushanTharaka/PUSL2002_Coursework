<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Customer Messages1.aspx.cs" Inherits="WEB_Project.Customer_Messages1" %>
...
<body style="background-image:url('cracc.jpg')">
    <form id="form1" runat="server">
        ...
        <div class="navbar">
            <a class="active" href="DoA HomePage.aspx" style="font-family: Arial"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
        </div>
                ...
                <table>
                    <tr>
                        <td style="background-color: white;">
                            <asp:Label ID="lblmsg1" runat="server" Text="Select a Message"></asp:Label></td>
                        <td>
                            <asp:TextBox ID="txtrply1" runat="server" TextMode="MultiLine"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Button ID="btnreply" Text="Reply" runat="server" OnClick="btnreply_Click" BackColor="#009933" BorderColor="White" Font-Bold="True" ForeColor="White" Height="30px" /></td>
                    </tr>
                </table>
            </div>
            <br /><br />
