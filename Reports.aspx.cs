...
namespace WEB_Project
{
    public partial class Reports : System.Web.UI.Page
    {
        ...
        void piechart()
        {
            ...
            con.Open();
            SqlCommand cmd2 = new SqlCommand("select count(National_Id) from FarmerOrders", con);
            SqlDataReader dr1 = cmd2.ExecuteReader();
            dr1.Read();
            ...
            SqlCommand cmd3 = new SqlCommand("update PieChartFarmer set Howmany=@howmany where Type='Not Selling Goods';", con);
            cmd3.Parameters.AddWithValue("@howmany", farmers);
            cmd3.ExecuteNonQuery();
            con.Close();

            con.Open();
            SqlCommand cmd4 = new SqlCommand("update PieChartFarmer set Howmany=@howmany1 where Type='Farmers Selling Goods';", con);
            cmd4.Parameters.AddWithValue("@howmany1", sellfarmers);
            cmd4.ExecuteNonQuery();
            con.Close();
            ...
            PieChart.Series[0].ChartType = SeriesChartType.StackedColumn;
        }
